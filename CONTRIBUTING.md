# Contributing to tricord

## Development Setup

### Prerequisites

- Rust 1.94.0 or later (stable toolchain)
...
```bash
TRICORD_PRECOMMIT_TEST=1 git commit -m "message"
```
...
- Add backticks around identifiers in doc comments (e.g., `` `proc_taskinfo` ``)
