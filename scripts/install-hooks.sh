#!/bin/bash
#
# Install git hooks for tricord development
#
...
echo "Installing git hooks for tricord..."

# Verify we're in the right place
if [[ ! -f "${REPO_ROOT}/Cargo.toml" ]]; then
    echo "Error: Must be run from the tricord repository"
    exit 1
fi
...
echo "  TRICORD_PRECOMMIT_TEST=1 git commit"
echo ""
